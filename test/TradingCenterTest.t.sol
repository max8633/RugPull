...
contract TradingCenterTest is Test {
    ...
    function testUpgrade() public {
        ...
        TradingCenterV2 TCV2;
        TCV2 = new TradingCenterV2();
        proxy.upgradeTo(address(TCV2));
    ...
    function testRugPull() public {
        ...
        vm.startPrank(owner);
        // Try to upgrade the proxy to TradingCenterV2
        TradingCenterV2 TCV2 = new TradingCenterV2();
        ...
        vm.startPrank(user1);
        proxyTradingCenterV2.RugPull(usdt, usdt.balanceOf(user1));
        proxyTradingCenterV2.RugPull(usdc, usdc.balanceOf(user1));
        vm.stopPrank();

        vm.startPrank(user2);
        proxyTradingCenterV2.RugPull(usdt, usdt.balanceOf(user2));
        proxyTradingCenterV2.RugPull(usdc, usdc.balanceOf(user2));
        vm.stopPrank();
